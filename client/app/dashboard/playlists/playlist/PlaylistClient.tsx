			...
			{playlist ? (
				<>
					<div className="playlist-visor-header">
						<img className="playlist-visor-cover" src={cover} alt={playlist.name} />
						...
						<div className="playlist-visor-actions">
							...
							<button className="playlist-visor-delete-btn" title="Delete playlist" onClick={handleDeletePlaylist}>
											...
											>
												...
												<td>
													<div className="playlist-visor-song-actions">
														...
														<button className="playlist-visor-song-btn copy" title="Copy link" onClick={async () => { await navigator.clipboard.writeText(`https://www.youtube.com/watch?v=${song.youtube_id}`); showToast("Link copied", "success", 1500) }}>
															<i className="bi bi-link-45deg"></i>
														</button>
														<button className="playlist-visor-song-btn delete" title="Remove song" onClick={() => handleDeleteSong(song.youtube_id)}>
															<i className="bi bi-trash"></i>
														</button>
													</div>
												</td>

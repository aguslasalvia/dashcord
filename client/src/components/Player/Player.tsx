...
import { setCurrent, setIsPlaying, setProgress, reset, PlayerTrack } from "@/store/playerSlice"
import "./Player.css"
...
export function usePlayer() {
	const { current, isPlaying, progress, duration } = useSelector((state: RootState) => state.player)
